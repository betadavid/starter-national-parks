...
console.log(button);
const divStatChild = document.querySelector(".stat>div");
console.log(divStatChild);
...
//Get all the divs that contain raitings
const divRatings = document.querySelectorAll(".rating-display>div");
...
for (let rating of ratings) {
  ...
  if (ratingValue > 4.7) {
    ...
    rating.style.color = "#3ba17c"; //green hex color
    */
...
const ratingTest = document.querySelector(".rating-display .value");
console.log("printing test: ",ratingTest);
